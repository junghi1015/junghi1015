    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leng_long', models.FloatField(blank=True, db_column='LENG_LONG', null=True)),
                ('leng_short', models.FloatField(blank=True, db_column='LENG_SHORT', null=True)),
                ('thick', models.FloatField(blank=True, db_column='THICK', null=True)),
                ('img_regist_ts', models.IntegerField(blank=True, db_column='IMG_REGIST_TS', null=True)),
                ('class_no', models.TextField(blank=True, db_column='CLASS_NO', null=True)),
                ...
                ('mark_code_back_anal', models.TextField(blank=True, db_column='MARK_CODE_BACK_ANAL', null=True)),
                ...
                ('change_date', models.TextField(blank=True, db_column='CHANGE_DATE', null=True)),
