...
img = "C:/Users/user/img/pill.jpg"
east = "C:/coding/python/opencv/EAST/frozen_east_text_detection.pb"
height = 480  # in model doc, model works in any pic with width and height multiple of 32
width = 480
padding = 0.06
...
for (startX, startY, endX, endY) in boxes:
    ...
    text =  pytesseract.image_to_string(img, lang='eng+Hangul')
...
img = cv2.imread("C:/Users/user/img/pill.jpg") 
east = "C:/coding/python/opencv/EAST/frozen_east_text_detection.pb"
height = 480  # in model doc, model works in any pic with width and height multiple of 32    width = 480
padding = 0.06
min_confidence = 0.5 # probability threshold 
